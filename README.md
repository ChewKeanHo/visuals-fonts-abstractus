# Abstractus Font | (Holloway) Chew, Kean Ho's Creative Visuals

[![banner](/Pictures/banner_1200x630.svg)](#)

A glyph-based creative display font designed by the GGBotNet primarily for
gaming industry uses. With its bold and unique style, it is also great for
posters, branding, and other typography artworks.
...
```
Title: Abstractus Font
Creators: GGBotNet
Packaged-By: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-fonts-abstractus
UUID: 766B2E16-DAC4-4CB3-A716-524B6A6C1C00
...
Procure: https://github.com/ChewKeanHo/visuals-fonts-abstractus
```
